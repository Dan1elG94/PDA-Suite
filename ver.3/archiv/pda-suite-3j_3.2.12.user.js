...
/* ================= VYHLADAT ZAKAZKU: pole len na 20 znakov =================
   Pole bolo cez celu sirku obrazovky; cislo zakazky ci materialu ma do 20 znakov,
   tak ma pole sirku na 20 znakov plus ikonky (zrusit, hladat). */
${B} #__pda_custom_search_ui__ .sapMListInfoTBar { justify-content:flex-start !important; }
${B} #__pda_custom_search_ui__ .sapMSF { width:calc(20ch + 96px) !important; max-width:100% !important;
...
`;
         ...
         * (Hotovo modra, Zostava sivomodra). Percento sa pocita z textu casov appky
        ...
        const K3_FARBY = [
            { hore: '#2b7fe0', stena: '#1c5fb5', dnu: '#154a8f' },   // hotovo
        ...
        function apply() {
            injectStyles();
            [priehladnePanely, patka, farbyPrehladu, oznacPrihlasenie, kolace3D].forEach((f) => {
