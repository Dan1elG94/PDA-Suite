...
/* ================= ZAKAZKA A MATERIAL: biela karta so strojarskou grafikou =================
   Len tato karta je plne biela (nie polopriehladna) a vpravo dole ma jemnu
   technicku kresbu - prirubu s otvormi na roztecnej kruznici, osi a koty ako na
   vykrese (SVG, jedna farba, nepriehladnost 13 %). Hlavicka ostava rovnaka ako
...
${B} #WorkcenterDetail--Main_SimpleForm .sapUiForm {
  background:url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 260 260' fill='none' stroke='%232c5fc6' stroke-linecap='round'><g opacity='.13' stroke-width='2.2'><circle cx='130' cy='130' r='98'/><circle cx='130' cy='130' r='42'/><circle cx='130' cy='130' r='34'/><circle cx='200.0' cy='130.0' r='8'/><circle cx='179.5' cy='179.5' r='8'/><circle cx='130.0' cy='200.0' r='8'/><circle cx='80.5' cy='179.5' r='8'/><circle cx='60.0' cy='130.0' r='8'/><circle cx='80.5' cy='80.5' r='8'/><circle cx='130.0' cy='60.0' r='8'/><circle cx='179.5' cy='80.5' r='8'/><circle cx='130' cy='130' r='70' stroke-width='1.1' stroke-dasharray='12 4 2 4'/><path d='M14 130H246M130 14V246' stroke-width='1.1' stroke-dasharray='16 4 2 4'/><path d='M32 250H228M32 243v14M228 243v14M32 250l10-4M32 250l10 4M228 250l-10-4M228 250l-10 4' stroke-width='1.3'/><path d='M232 32v196M225 32h14M225 228h14' stroke-width='1.3'/></g></svg>") right -40px bottom -34px / 270px 270px no-repeat, #ffffff !important;
...
${B} #Login--Login_Button { height:auto !important; }
${B} #Login--Login_Button .sapMBtnInner { display:inline-flex !important; align-items:center !important;
  ...
  transition:transform .13s ease, box-shadow .13s ease !important; }
${B} #Login--Login_Button .sapMBtnInner::before { content:''; flex:0 0 auto; width:18px; height:18px;
...
${B} #Login--Login_Button:hover .sapMBtnInner { transform:translateY(-2px);
...
${B} #Login--Link, ${B} [id^="Login--"] .sapMLnk, ${B} .sapMLnk[id^="Login--"] {
...
${B} #Login--Link *, ${B} [id^="Login--"] .sapMLnk * { color:inherit !important; text-shadow:none !important; }
${B} #Login--Link:hover, ${B} [id^="Login--"] .sapMLnk:hover { background:#fff !important; color:#1a5fc4 !important;
...
`;
        ...
        function apply() {
            injectStyles();
            [priehladnePanely, patka, farbyPrehladu].forEach((f) => {
