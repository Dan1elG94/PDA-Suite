...
/* ================= uvodna obrazovka: oblasti pracovisk vo farbe =================
   ...
   farby a ram v nej. */
${B} #__pda_overview__ .ov-g { --ov-farba:#6b7c95; border:1px solid rgba(190,205,228,.9) !important;
  border-left:5px solid var(--ov-farba) !important; border-radius:12px !important;
  background:rgba(255,255,255,.9) !important; box-shadow:0 3px 12px rgba(20,60,120,.08) !important;
  margin-bottom:10px !important; transition:box-shadow .15s, border-color .15s; }
${B} #__pda_overview__ .ov-g:hover { box-shadow:0 6px 18px rgba(20,60,120,.14) !important; }
${B} #__pda_overview__ .ov-g.open { border-color:color-mix(in srgb, var(--ov-farba) 55%, white) !important;
