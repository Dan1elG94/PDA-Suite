...
${B} ${CASY} { background:rgba(255,255,255,.62) !important; -webkit-backdrop-filter:blur(8px); backdrop-filter:blur(8px);
  border:1px solid rgba(255,255,255,.75) !important; border-radius:18px !important;
  box-shadow:0 6px 22px rgba(16,36,63,.08) !important; padding:14px 16px 16px !important;
...
${B} ${CASY} > .sapMVBox { flex:1 1 0 !important; min-width:140px !important; position:relative !important;
  background:rgba(255,255,255,.92) !important; border:1px solid #e1e9f4 !important; border-radius:14px !important;
  box-shadow:0 2px 10px rgba(16,36,63,.06) !important; padding:12px 10px 12px !important;
...
/* ================= PARALELNE PROCESY ================= */
${B} ${SEKCIA} .sapMList { background:rgba(255,255,255,.62) !important; -webkit-backdrop-filter:blur(8px);
  backdrop-filter:blur(8px); border:1px solid rgba(255,255,255,.75) !important;
  box-shadow:0 6px 22px rgba(16,36,63,.08) !important; }
/* jedna polozka = biela karta (namiesto zelenej plochy) */
${B} ${ZOZNAM} .sapMLIB, ${B} ${ZOZNAM} .pda-aktivita { background:rgba(255,255,255,.95) !important;
  border:1px solid #e1e9f4 !important; border-radius:14px !important;
